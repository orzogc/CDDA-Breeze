...
static void debug_menu_force_temperature()
{
    ...
    if( tempmenu.ret == 0 ) {
        ...
        if( option == "celsius" ) {
            if( forced_temp ) {
                current = static_cast<int>(units::to_celsius( *forced_temp ));
            }
            ...
            if( forced_temp ) {
                current = static_cast<int>(units::to_kelvin( *forced_temp ));
            }
            ...
            if( forced_temp ) {
                current = static_cast<int>(units::to_fahrenheit( *forced_temp ));
            }
