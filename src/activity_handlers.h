...
void vehicle_do_turn( player_activity *act, Character *you );
void vehicle_start( player_activity *act, Character *you, bool resuming = false );
void vehicle_canceled( player_activity *act, Character *you );
